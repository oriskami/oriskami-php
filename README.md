...
| ReviewerBinding | <a href="https://ubivar.com/docs/php#create_a_reviewerbinding">`{}`</a>| <a href="https://ubivar.com/docs/php#retrieve_a_reviewerbinding">id</a>  |<a href="https://ubivar.com/docs/php#update_a_reviewerbinding">`{}`</a>|<a href="https://ubivar.com/docs/php#delete_a_reviewerbinding">id</a>|<a href="https://ubivar.com/docs/php#list_reviewerbinding">`{}`</a>| [![](https://status.ubivar.com/ubivar-php/resources/reviewerbinding.svg)](https://github.com/ubivar/ubivar-php/blob/master/tests/ReviewerBinding.php)| 
