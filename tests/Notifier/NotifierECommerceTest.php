...
class NotifierECommerceTest extends TestCase
{
    ...
    public function testClass()
    {
        ...
        $this->assertInstanceOf("Oriskami\\NotifierECommerce", $this->updated1[0]);
        $this->assertInstanceOf("Oriskami\\NotifierECommerce", $this->updated1[0]);
        $this->assertInstanceOf("Oriskami\\NotifierECommerce", $this->updated2[0]);
        $this->assertInstanceOf("Oriskami\\NotifierECommerce", $this->listed1[0]);
    }
